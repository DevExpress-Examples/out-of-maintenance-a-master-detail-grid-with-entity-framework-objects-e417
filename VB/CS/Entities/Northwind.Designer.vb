...
Namespace Entities
    ...
    Partial Public Class Customers
        ...
        ''' No Metadata Documentation available.
        ''' </summary>
        <XmlIgnoreAttribute(), SoapIgnoreAttribute(), DataMemberAttribute(), EdmRelationshipNavigationPropertyAttribute("NorthwindModel", "FK_Orders_Customers", "Orders")> _
        Public Property Orders() As EntityCollection(Of Orders)
            Get
                Return DirectCast(Me, IEntityWithRelationships).RelationshipManager.GetRelatedCollection(Of Orders)("NorthwindModel.FK_Orders_Customers", "Orders")
            End Get
            Set(ByVal value As EntityCollection(Of Orders))
                If (value IsNot Nothing) Then
                    DirectCast(Me, IEntityWithRelationships).RelationshipManager.InitializeRelatedCollection(Of Orders)("NorthwindModel.FK_Orders_Customers", "Orders", value)
                End If
            End Set
        End Property
    ...
    ''' No Metadata Documentation available.
    ''' </summary>
    <EdmEntityTypeAttribute(NamespaceName:="NorthwindModel", Name:="Orders"), Serializable(), DataContractAttribute(IsReference:=True)> _
    Partial Public Class Orders
        ...
        Public Shared Function CreateOrders(ByVal orderID As Global.System.Int32) As Orders
        ...
        ''' No Metadata Documentation available.
        ''' </summary>
        <XmlIgnoreAttribute(), SoapIgnoreAttribute(), DataMemberAttribute(), EdmRelationshipNavigationPropertyAttribute("NorthwindModel", "FK_Orders_Customers", "Customers")> _
        Public Property Customers() As Customers
            Get
                Return DirectCast(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of Customers)("NorthwindModel.FK_Orders_Customers", "Customers").Value
            End Get
            Set(ByVal value As Customers)
                DirectCast(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of Customers)("NorthwindModel.FK_Orders_Customers", "Customers").Value = value
            End Set
        End Property
        ''' <summary>
        ''' No Metadata Documentation available.
        ...
        Public Property CustomersReference() As EntityReference(Of Customers)
            Get
                Return DirectCast(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of Customers)("NorthwindModel.FK_Orders_Customers", "Customers")
            End Get
            Set(ByVal value As EntityReference(Of Customers))
                If (value IsNot Nothing) Then
                    DirectCast(Me, IEntityWithRelationships).RelationshipManager.InitializeRelatedReference(Of Customers)("NorthwindModel.FK_Orders_Customers", "Customers", value)
                End If
            End Set
        End Property
